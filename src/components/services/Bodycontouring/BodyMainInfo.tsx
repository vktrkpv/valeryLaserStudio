...
import bodyMainPhoto from '../../../assets/body/1.png';
import BodyImportantInfo from './BodyImportantInfo';
import BodyPros from './BodyPros';
  ...
  return (
    <div>
      <div
        ...
        style={{ backgroundImage: `url(${bodyMainPhoto})` }}
      >
