...
import ProsLaserHairRemoval from './ProsLaserHairremoval';
        ...
        <div>
            <div className="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-md flex flex-col md:flex-row items-center gap-8">
                <div className="flex-1 text-center md:text-left">
                    ...
                    Stop spending time on shaving, or experiencing hurt from a painful waxing experience.
                    Laser Hair Removal is a safe and effective hair removal option that saves you money in the long run.
                    </p>
                ...
                <img src={laserPhoto} alt="Laser Hair Removal" className="rounded-lg shadow-lg w-full max-w-md" />
                </div>
            </div>
