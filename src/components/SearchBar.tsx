...
import { servicesSearch } from "../data/servicesSearchData";
 ...
 function SearchBar(){
    ...
    const filteredServices = servicesSearch.filter((service) => service.title.toLowerCase().includes(searchTerm.toLowerCase()))
    ...
    return(
        <div className="relative w-full max-w-md">
            ...
            <div>
                {searchTerm && (
                    <ul 
                    className="absolute left-0 mt-2 w-full max-w-md bg-white shadow-xl rounded-2xl p-4 max-h-60 overflow-y-auto transition-all duration-300 ease-in-out"                   >
                        ...
                        (
                            ...
                            <li className="p-4 text-gray-500 text-center rounded-lg bg-[#F5F5F5]">No results found</li>
                        )
                        }
